...
def calculate_steam_pipe_size(
    steam_quantity,
    specific_volume,
    dynamic_viscosity,
    steam_pipe_length,
    fluid_service="Steam",
    min_velocity=STEAM_MIN_VELOCITY,
    max_velocity=STEAM_MAX_VELOCITY,
    max_pressure_drop=STEAM_MAX_PRESSURE_DROP_BAR):
    fitting_quantities = {
    ...
    mass_flow = steam_quantity / 3600

    # -----------------------------
    # Volumetric Flow (m³/s)
    # -----------------------------

    volumetric_flow = mass_flow * specific_volume
    ...
    for _, pipe in pipe_db.iterrows():
        ...
        straight_pipe_length=steam_pipe_length,
        internal_diameter=pipe["ID_mm"] / 1000,
